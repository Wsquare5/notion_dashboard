...
def main():
    ...
    if new_symbols:
        print("\n⚠️  注意：新币种已创建但只有基础元数据。")
        print("   请运行以下命令获取完整市场数据（MC、FDV、OI、Funding等）：")
        print("   1. collect_websocket_data.py  # 收集实时价格和交易量")
        print("   2. update_from_websocket.py   # 更新到Notion（计算MC/FDV等）")
        print("   或使用菜单选项 [3] 一键完成以上步骤。")
    print("="*80)
